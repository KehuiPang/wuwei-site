...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/voice`, changeFrequency: "weekly", priority: 0.8, alternates: { languages: { "zh-CN": `${base}/voice`, en: `${base}/en/voice` } } },
    { url: `${base}/shot`, changeFrequency: "weekly", priority: 0.8, alternates: { languages: { "zh-CN": `${base}/shot`, en: `${base}/en/shot` } } },
    { url: `${base}/en/voice`, changeFrequency: "weekly", priority: 0.8, alternates: { languages: { "zh-CN": `${base}/voice`, en: `${base}/en/voice` } } },
